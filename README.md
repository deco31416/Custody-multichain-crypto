![Cover Image](https://github.com/deco31416/custody-multichain-crypto-wallet/blob/main/public/cover.svg?raw=true)

![Version](https://img.shields.io/badge/version-0.2.8-blue?style=flat-square)
![License](https://img.shields.io/badge/license-MIT-green?style=flat-square)
![Author](https://img.shields.io/badge/author-deco31416-blueviolet?style=flat-square)
![Status](https://img.shields.io/badge/status-building-yellow?style=flat-square)
![Open Source](https://badgen.net/badge/open-source/yes/green?style=flat-square)
![Node](https://img.shields.io/badge/node-%3E=10-blue?style=flat-square)
![TypeScript](https://img.shields.io/badge/TS-supported-3178c6?style=flat-square)
![TSDX](https://img.shields.io/badge/bundler-tsdx-ff69b4?style=flat-square)
![UTXO](https://img.shields.io/badge/UTXO-supported-blue?style=flat-square)
...
Built for scalability, flexibility, and simplicity.

## Installation

```bash
npm install custody-multichain-crypto-wallet
```

Using yarn,

```bash
yarn add custody-multichain-crypto-wallet
```
...
```javascript
const multichainWallet = require('custody-multichain-crypto-wallet');
```

### TypeScript

```typescript
import * as multichainWallet from 'custody-multichain-crypto-wallet';
```
...
- [Custody Multichain Crypto Wallet](#custody-multichain-crypto-wallet)
  ...
  - [Methods](#methods)
    ...
    - [👤 Forked \& Maintained by deco31416](#-forked--maintained-by-deco31416)
...
### 👤 Forked & Maintained by [deco31416](https://github.com/deco31416)

For more information, documentation, and updates,  
🌐 visit 👉 [deco31416.com](https://deco31416.com)
